...
However, the data file was not included in the importable_data folder, because it is too large to be uploaded to github. 
...
1. Select the useful variables: **precinct**, **candidate**, **votes**, **mode**. For more information about the removed variables, see the codebook in the raw data folder. 
...
**DOI:** N/A  
**Date Downloaded:** Mar 27, 2020  
**Filename(s):** raw_data/census_tract_map.pdf
**Unit of observation:** N/A 
**Dates covered:** 2010
