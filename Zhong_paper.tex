...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extreme <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{medage =} \KeywordTok{c}\NormalTok{(}\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{medage), }\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{medage)),}
                      \DataTypeTok{medincome =} \KeywordTok{c}\NormalTok{(}\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{medincome), }\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{medincome)),}
                      \DataTypeTok{white_pct =} \KeywordTok{c}\NormalTok{(}\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{white_pct), }\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{white_pct)),}
                      \DataTypeTok{public_pct =} \KeywordTok{c}\NormalTok{(}\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{public_pct), }\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{public_pct)),}
                      \DataTypeTok{time_pct =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{time_pct), }\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{time_pct)),}
                      \DataTypeTok{trump_pct =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{trump_pct), }\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{trump_pct)),}
                      \DataTypeTok{voter_turnout =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{voter_turnout), }\KeywordTok{max}\NormalTok{(final_data}\OperatorTok{$}\NormalTok{voter_turnout)),}
                      \DataTypeTok{current_plan =} \KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{))}
                      
\NormalTok{extreme <-}\StringTok{ }\NormalTok{extreme }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{current_plan =} \KeywordTok{as.factor}\NormalTok{(current_plan))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{values_compare <-}\StringTok{ }\NormalTok{final_data }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{predicted =} \KeywordTok{predict}\NormalTok{(mod1, }\DataTypeTok{newdata =}\NormalTok{ final_data)) }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{select}\NormalTok{(yes_pct, predicted)}
\end{Highlighting}
\end{Shaded}
