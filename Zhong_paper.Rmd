...
The remaining paper is structured as follows. In Section 2, I include a background of Gwinnett’s current public transit system, the content of the proposition, and the referendum. In Section 3, I describe the data sources, methods, and models. Section 4 presents the results and discussions. Finally, Section 5 concludes this paper. 
